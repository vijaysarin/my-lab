                    ...
                    return new Promise(function executor(resolve, reject, onCancel) {
                        try {
                            ...
                            if (typeof adapter === 'function') {
                                adapter(resolve, reject, config, onCancel);
                            }
                        } catch (e) {
                            reject(e);
                        }
...
/***/
            function (module, exports, __webpack_require__) {
                ...
                module.exports = function xhrAdapter(resolve, reject, config, onCancel) {
                    ...
                    // cancelling if using BlueBird's promise implementation

                    var abortRequest = function () {
                        request.abort();
                    }

                    onCancel && onCancel(abortRequest);
